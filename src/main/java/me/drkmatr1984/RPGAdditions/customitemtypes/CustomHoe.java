...
public class CustomHoe extends CustomTexturedTool {
	
	public CustomHoe(DamageableItem damageable, int durability, double attackSpeed, String identifier, String name) {
