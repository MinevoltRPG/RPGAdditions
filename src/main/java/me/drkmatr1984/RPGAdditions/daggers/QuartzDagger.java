...
public class QuartzDagger extends CustomTexturedTool {

	
	public QuartzDagger() {
		super(DamageableItem.DIAMOND_SWORD, "rpg_additions:quartz_dagger", "quartz_dagger");
		...
		setDisplayName("Quartz Dagger");
		setFakeDurability(203);   //Durability
		...
		list.add(new CustomShapedRecipe().setShape("xxx", "xdx", "sxx").setIngredient('x', Material.AIR)
				.setIngredient('d', Material.QUARTZ).setIngredient('s', Material.STICK));
