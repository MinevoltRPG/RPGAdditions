...
public class AcaciaWoodDagger extends CustomTexturedTool {

	@SuppressWarnings("deprecation")
	public AcaciaWoodDagger() {
		super(DamageableItem.DIAMOND_SWORD, "rpg_additions:acacia_wood_dagger", "acacia_wood_dagger");
		...
		setDisplayName("Acacia Wood Dagger");
		...
		list.add(new CustomShapedRecipe().setShape("xxx", "xdx", "sxx").setIngredient('x', Material.AIR)
				.setIngredient('d', new RecipeIngredient(Material.WOOD, TreeSpecies.ACACIA.getData())).setIngredient('s', Material.STICK));
